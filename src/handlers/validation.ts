      ...
      if (req.method === 'GET' || req.method === 'DELETE') {
        ...
        try {
          ...
          return NextResponse.json(
            { error: 'Invalid JSON body', cause: error },
            { status: 400 }
          );
        }
        ...
        try {
          ...
          return NextResponse.json(
            { error: 'Invalid form data', cause: error },
            { status: 400 }
          );
        }
      }
 ...
 */
function validateWithSchema(data: any, schema: ValidationSchema): { valid: boolean; errors?: Record<string, string> } {
